...
{
    /// <summary>
    /// Validation tag for ITagger holding clang-tidy validation warning message.
    /// </summary>
    ...
    /// ValidationTags are then used by Classifier for highlighting the code using ValidationWarningFormat 
